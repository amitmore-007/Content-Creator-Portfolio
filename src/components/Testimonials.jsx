...
const TESTIMONIALS = [
  {
    quote:
      "I had zero podcasting experience when I approached Shakti & his team. They guided me through every step. Concept development, branding, recording sessions, post production & distribution. The team truly understood my academic audience & helped me communicate complex topics in an engaging way. Outstanding service from start to finish.",
    name: "Atharva More",
  ...
  {
    quote:
      "Had such a great experience working with you! ✨ Super comfortable shoot, amazing direction, and the photos turned out BEAUTIFUL. You really know how to capture the vibe naturally. Can't wait to work together again..",
    name: "Prachi Kale",
    role: "Model, Founder (Thrift with Sachi)",
    initials: "PK",
  },
  {
    quote:
