  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      tl.fromTo(
        ...
        .set(heroRef.current.querySelectorAll(".hero-word-row"), {
          overflow: "visible",
        });
      ...
      <div className="hero-content">
        <div className="hero-label-wrap" data-hero-text>
          <span className="section-label">
            Filmmaker • Content Strategist • Visual Storyteller
          </span>
        ...
        <p ref={subRef} className="hero-sub">
          I craft cinematic content that helps brands, creators, and businesses
          stand out online. <br />
          From high-impact reels to story-driven campaigns and YouTube films.
        </p>
